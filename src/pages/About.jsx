  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
            B.Tech in Electronics and Communication Engineering student with hands-on experience in "IoT-Based Smart Home" Projects and  Work on Arduino UNO Microcontroller with Node MCU EPS8622 and HC-SR501 PIR Motion Sensor. Seeking opportunities to apply skills and contribute to
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>KU (Kolhan University)</strong> — Chaibasa Engineering College,, India
                  
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Percentage: 72.53%
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>2018 – 2021</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>S.B.T.E.J</strong> — Govt polytechnic college kharsawan,Jamshedpur
                                  </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  State Board | Percentage: 72.51%
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>+2 School High School</strong> — Jharkhand,
                  India
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  JAC Board | Percentage: 61.2%
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>Completed in 2012</p>
              </div>
            </motion.div>
          </div>
        </motion.div>
